...
with locationskip
window show
"My class ends a good twenty minutes early, so I walk down to the lobby and buy a can of juice, then sit down on a bench and wait for Rin. I pull out a novel from my bag and search for the place I was at."
...
scene ev rin_nap_total:
    pause 0 xalign 0.5 yalign 0.5 zoom 1.0 subpixel True
    ease 20.0 zoom 1.05
with whiteout
...
scene ev rin_nap_close_nohand:
    pause 0 yalign 1.0 subpixel True
with locationchange
...
scene ev rin_nap_close_nohand:
    pause 0 yalign 0.0 subpixel True
with locationchange
...
show rin relaxed_sleepy_close_ss:
    pause 0 center
    pause 0 alpha 0.0 ypos 1.3 subpixel True
...
show rin relaxed_nonchalant_close_ss:
    pause 0 subpixel False alpha 1.0 ypos 1.17
with charachange
...
with charachange
emi "Is that weird?"
"She leans against the wall, managing to look distraught, yet still cheerful as always. I get a strange feeling about it, as though I was talking to two people at the same time."
...
scene bg gallery_atelier_close:
    pause 0 xalign 0.5 yalign 0.0 subpixel True
...
"Yesterday, both of us said something we couldn't take back, and there's no way it can be undone. I want to say something, but Rin forbade from doing so."
...
n "Rin works like a demon. There is barely a moment when she's without a brush between her toes, or walking in circles around her current work in progress, estimating it from every angle and distance."
...
scene ev rin_orange_large:
    pause 0 xalign 0.5 yalign 1.0 subpixel True
...
hi "Just be to be clear - you are speaking metaphorically, right? Like, learning to paint from scratch again or whatever, so to speak?"
...
show ovl rin_galleryskylight:
    pause 0 truecenter
    pause 0 zoom 0.8 subpixel True
...
show rin relaxed_sleepy_cas_ni:
    pause 0 xalign 0.5 yanchor 1.0 ypos 1.1
    easein 0.5 ypos 1.0
with charaenter
...
"I really don't want to explain the circumstances between Rin and I, so I get flustered and end up mumbling something unclear."
hi "I, um…"
show sae doubt
with charachange
...
scene ev rin_masturbate_away:
    pause 0 truecenter
    pause 0 subpixel True zoom 1.0
...
with charachange
"Rin looks a bit panicky, a bit anxious, a bit defensive. It's as if she was a completely different person last night. Perhaps she was."
...
show rin basic_absent_cas_close
with charachange
rin "So you don't want to do that sort of things?"
