...
mu "Good to hear. Oh, and I've noticed that Ikezawa's attendance and marks have improved since you came to be friends. I'd like to thank you for that."
...
show kenji happy:
    pause 0 2.0
    pause 0 "kenji neutral" with Dissolve(0.5, alpha=True)
    pause 0 3.0
    pause 0 "kenji happy" with Dissolve(0.5, alpha=True)
    pause 0 1.0
    pause 0 "kenji neutral" with Dissolve(0.5, alpha=True)
    pause 0 4.0
    pause 0 "kenji tsun" with Dissolve(0.5, alpha=True)
    repeat
...
n "It's only natural that my mind would wander to other places, and more importantly, other people. The Lilly-shaped hole in the daily life of Hanako and I has been pretty noticeable for a while now."
...
show lilly basic_weaksmile_cas
with charachange
li "There'd be clothes you could use there. Akira still occasionally goes there, after all, and I think some of our parents' clothing is still in storage."
show lilly basic_smile_cas
with charachange
...
show lilly cane_reminisce_cas:
    pause 0 xanchor 0.5 xpos 0.3 yalign 0.52 rotate 0 zoom 1.0
    linear 0.1 xpos 0.25 rotate -6 zoom 1.2
show hanako defarms_strain_cas:
    pause 0 xanchor 0.5 xpos 0.7 yalign 0.52 rotate 0 zoom 1.0
...
show ev lilly_wheat_large:
    pause 0 yalign 0.5 xalign 0.0 subpixel True
...
scene ev lilly_wheat_small:
    pause 0 xalign 0.5 yalign 0.5 zoom 1.1 subpixel True
    ease 16.0 zoom 1.0
with whiteout
...
show evh lilly_handjob_chest_normal:
    pause 0 xalign 0.7 yalign 1.0 subpixel True
...
show evh lilly_handjob_chest_normal:
    pause 0 zoom 1.0 xalign 0.4 yalign 0.2
...
"After weeks of blissful friendship, whiling away the days with shared meals and chatter with little meaning, the relationship of Lilly and I, no, that of all of us, has irreversibly changed."
"I can't take this."
hi "Lilly…"
...
show hanagown smile_rn
with charachange
ha "Hisao, do you mind if me and Lilly go outside for a bit?"
hi "Ah, no, feel free…"
