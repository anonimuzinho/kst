...
scene ev emitrack_finishtop:
    pause 0 xalign 0.5 yalign 0.0 zoom 4.0 subpixel True
    pause 0 0.2
...
show rin invis:
    pause 0 yalign 1.0 xpos 1.0 xanchor 0.6
with None
show yuukoshang neutral_down:
    pause 0 xpos 0.55
...
show emi basic_annoyed_gym:
    ...
    parallel:
        ease 0.5 xpos 0.7
    parallel:
        pause 0 "emi basic_closedhappy_gym" with Dissolve(0.5, alpha=True)
...
show ev emi_firstkiss:
    pause 0 truecenter
    pause 0 zoom 4.0 rotate 20 subpixel True
    pause 0 0.7
