...
scene ev shizu_chess_large:
    pause 0 subpixel True xanchor 1140 yanchor 1100 xpos 400 ypos 300 zoom 1.0
...
scene ev shizu_chess_base:
    pause 0 subpixel True zoom 1.05 truecenter
    easein 5.0 zoom 1.0
with flash
...
scene evbg kenji_glasses:
    pause 0 truecenter
    pause 0 subpixel True zoom 0.82
...
with dissolvecharamove
show shizu behind_blank_close:
    pause 0 yalign 1.0 xpos 1.0 xanchor 0.8
with charaenter
...
with locationskip
"So I just hold on to the thought as the three of us walk onto campus and then separate; Shizune to the student council room, and Misha and I to our dorms."
...
scene ev shizutanabata:
    pause 0 zoom 8.0 rotate 45.0 subpixel True truecenter
