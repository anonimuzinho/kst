...
scene evbg hanako_emptyclassroom:
    pause 0 truecenter
    pause 0 subpixel True zoom 0.9
    easein 20.0 zoom 1.0
show evfg hanako_emptyclassroom:
    pause 0 truecenter
    pause 0 subpixel True zoom 0.8
    easein 20.0 zoom 1.0
with whiteout
...
"In my time here at Yamaku, I've noticed that the other students have a wide range of adjustment to their disabilities, on a purely practical level. Miki is one of those that seem to have some trouble."
...
scene ev hisao_scar_large:
    pause 0 xanchor 0 yanchor 0 xpos -600 ypos -140
with whiteout
...
show hanako basic_worry_ss
with charachange
ha "Okay. B-but in in return… you have to t-tell me about your life as well…"
hide hanako
with charaexit
...
hi "I got good marks, and I played soccer with my friends. I spent a fair bit of time hanging out with them after school as well. Did get teased a bit over my hair, though."
...
show ev hanako_scars_large:
    pause 0 xalign 0.0 yalign 1.0 subpixel True
...
"A couple of other classmates are looking at us and gossiping between themselves as they throw sidelong glances. They must also have noticed Hanako and I coming in together earlier."
...
nvl clear
nvl show dissolve
n "\n\nIt feels like there's a complete emotional disconnect between Hanako and I. We haven't known each other for all that long, and despite wanting to start going out with her, I really don't know that much about how Hanako views things."
