...
show rin basic_awayabsent:
    ...
    parallel:
        ease 0.3 center
    parallel:
        pause 0 "rin basic_absent" with Dissolve(0.3, alpha=True)
with Pause(0.5)
...
show rin basic_sad:
    ...
    parallel:
        pause 0 "rin basic_lucid" with Dissolve(0.3, alpha=True)
with Pause(1.5)
stop ambient fadeout 7.0
scene ev rin_gallery:
    pause 0 truecenter
    pause 0 zoom 0.9 subpixel True
...
show nomiya serious
with charachange
"Sae's remark makes him stop in his tracks and check his wristwatch."
...
scene ev rin_trueend_normal:
    pause 0 truecenter
    pause 0 zoom 1.2 rotate -6 subpixel True
...
scene ev rin_trueend_sad:
    pause 0 truecenter
    pause 0 zoom 1.0 rotate 0 subpixel False
with locationchange
...
scene ev rin_trueend_gone:
    pause 0 "ev rin_trueend_gone_ni" with Dissolve(10.0)
with None
...
show bg school_nomiya:
    pause 0 "bg school_nomiya_ss" with Dissolve(8.0)
show rin negative_crying_superclose:
    pause 0 "rin negative_crying_superclose_ss" with Dissolve(8.0, alpha=True)
with None
stop music fadeout 5.0
...
scene ev rin_wet_arms:
    pause 0 center
    pause 0 xalign 0.0 subpixel True
...
scene evh rin_h_strain:
    pause 0 truecenter
    pause 0 zoom 1.2 subpixel True
...
show dandelion full:
    pause 0 alpha 0.0 xalign 0.5 yanchor 1.0 ypos 1.2 subpixel True
...
show evbg rin_goodend_base:
    pause 0 center
    pause 0 subpixel True xalign 0.0
    pause 0 1.0
    easein 20.0 xalign 1.0
show dandelionsbg dense
show rin goodend_1:
    pause 0 center
    pause 0 subpixel True xalign -0.5
    pause 0 1.0
    easein 20.0 xalign 1.0
show dandelionsfg dense
show evfg rin_goodend:
    pause 0 center
    pause 0 subpixel True xalign -1.0
    pause 0 1.0
    easein 20.0 xalign 1.0
with whiteout
...
"Yet Rin stays on her rock, peering at the distant horizon where the rainclouds are drifting further away from us."
...
show evbg rin_goodend_base:
    pause 0 subpixel False xalign 1.0
show rin goodend_1b:
    pause 0 subpixel False xalign 1.0
show evfg rin_goodend:
    pause 0 subpixel False xalign 1.0
...
show rin goodend_2_hires:
    pause 0 subpixel True yalign 0.0 xalign 1.0 zoom 0.769
    acdc_warp 12.0 zoom 1.0
    pause 0 subpixel False
show evfg rin_goodend:
    pause 0 subpixel True yalign 0.0
