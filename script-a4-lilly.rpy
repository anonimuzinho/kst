...
show shizu invis:
    pause 0 xanchor 0.5 xpos 0.0
show misha invis_close:
    pause 0 xanchor 0.5 xpos -0.1
with None
show shizu basic_normal:
    pause 0 xanchor 0.5 xpos 0.3
show misha perky_confused_close:
    pause 0 xpos 0.1
show hanako invis:
    pause 0 xpos 1.1
...
hi "Don't worry, you can still gain some marks if you start studying now."
hi "Maybe."
...
scene ev lilly_bedroom:
    pause 0 truecenter
    pause 0 zoom 1.0 subpixel True
...
hide akira
with None
"And with that she turns and strides out of the door, a hand held high as she disappears into the darkened hallway, closing the door behind her."
show lilly basic_smile_paj:
    pause 0 center
    pause 0 ypos 1.17
...
show stallphoto_insert:
    pause 0 alpha 0.0 xalign 0.5 yanchor 0.5 ypos 0.7 subpixel True
...
$ renpy.music.set_volume(1.0, 1.0, channel="music")
show stallphoto_insert:
    pause 0 alpha 1.0 xalign 0.5 yanchor 0.5 ypos 0.5 subpixel True
...
scene ev lilly_restaurant_wine:
    pause 0 zoom 1.05 xalign 0.0 yalign 0.5 subpixel True
...
"Probably a more noncomittal answer than I should give, but it isn't without cause. I've never looked at the situation from Iwanako's perspective like that before."
label en_L24b:
...
show ev hisao_teacup:
    pause 0 truecenter
    pause 0 alpha 0.0 subpixel True
...
scene ev hisao_teacup:
    pause 0 truecenter
    pause 0 zoom 1.0 subpixel True alpha 1.0
...
"…"
"Silence."
"This seems to be happening more and more between Lilly and I, recently. After a few seconds, I finally find something to talk about."
...
scene evh lilly_masturbate:
    pause 0 truecenter
    pause 0 subpixel True zoom 1.1
...
show lilly superclose_shock:
    pause 0 xalign 0.5 yanchor 0.5 ypos 0.15 alpha 0.0
    pause 0 subpixel True rotate 180
    easein 1.0 alpha 1.0 ypos 0.3
with Pause(1.0)
li "Hisao? Are you okay? Hisao!?"
hi "I'm fine, Lilly. I'm… fine."
show lilly superclose:
    pause 0 xalign 0.5 yanchor 0.5 ypos 0.3 alpha 1.0
    pause 0 subpixel True rotate 180
with charachange
...
hi "I've got plans which will require going to one, and my marks are good enough. It's more a matter of how I'll pay to do so."
...
scene ev akira_park:
    pause 0 subpixel True xalign 1.0 yalign 0.0 zoom 1.0
...
show ev hisao_teacup:
    pause 0 truecenter
    pause 0 zoom 0.85 subpixel True
    acdc_warp 15.0 zoom 0.8
with locationchange
...
n "Even I'm moving forward, in the end. With the marks I've gotten so far in Yamaku, much less after such a rocky beginning, the path to get into teaching science as a career seems straightforward."
...
"Hakamichi… class 3-3… Huh. Her family home is in Saitama."
...
with charachange
ha "But I…"
"Lilly cuts her words short as she brings her hand to Hanako's head and brushes her fringe to the side, gently pressing her lips to Hanako's forehead."
...
"In the end, Lilly's an irreplaceable part of the lives of both Hanako and I."
...
scene ev lilly_airport_end:
    pause 0 truecenter
    pause 0 zoom 1.2 rotate -8 subpixel True
...
scene bg hosp_ext_fb:
    pause 0 xalign 0.5 yalign 0.52 rotate -6 zoom 1.2
...
show bg hosp_ceiling:
    ...
    linear 5.0 alpha 1.0
with None
"My eyes open, and I simply stare at the ceiling for some time. It's about as interesting at the television would be, mounted in its metal rack hanging off the ceiling ahead of the bed."
...
li "Hisao! Hisao!"
"Lilly's body trembles as her tears blot the dark blue sheets, her emotions flooding through her carefully maintained exterior."
...
show evbg lilly_goodend:
    pause 0 truecenter
    pause 0 zoom 3.0 subpixel True
    pause 0 1.0
    linear 0.5 zoom 0.9
    easein 12.0 zoom 0.8
show evfg lilly_goodend:
    pause 0 truecenter
    pause 0 zoom 6.0 subpixel True
    pause 0 1.0
    linear 0.5 zoom 1.2
    easein 12.0 zoom 0.8
with whiteout
