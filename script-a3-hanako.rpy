...
show hanako basic_normal_close:
    ...
    pause 0 ypos 1.09
with charamove
"And then… we're alone. It may be all well and good to leave Hanako and I alone to have some time together, but all it typically means is the two of us sitting near each other in silence for a while."
...
show evfg hanako_breakdown_up:
    ...
    pause 0 zoom 1.0 subpixel False
with charachange
"Only the fact that she tries to inch away once she feels Shizune, Misha and I looking at her tells me that she is even still conscious. We look away, and at least in my case, it's partly out of shame that it's gotten to this point."
...
show shizu behind_blank_close:
    pause 0 tworight
    pause 0 xpos 0.85 ypos 1.09
show misha perky_sad_close:
    pause 0 twoleft
    pause 0 xpos 0.15 ypos 1.09
show hanako emb_downtimid_close:
    pause 0 center
    pause 0 ypos 1.09
...
mu "Your marks have been good in this class so far, which makes me think you won't have any trouble catching up on what we've been doing."
...
hi "You said you also had some bad news… what's the matter? Do they concern Hanako?"
...
"It feels as if she'd judging me. It's a very strange, vaguely uncomfortable feeling."
hi "Hanako…?"
...
scene ev hanako_billiards_smile_close:
    pause 0 xalign 0.0 yalign 0.0 zoom 0.8 subpixel True
...
with charaenter
ha "I-it's small."
hi "Well, yes. It took Lilly and I some time to find it."
