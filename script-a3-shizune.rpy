...
show misha sign_smile_cas
with charachange
mi "Hm~, it's no problem, though, Hicchan~! Shicchan and I can share a room if have to. Well~, unless hers is being used for something else now."
hide shizu
with charaexit
hide misha
with charaexit
...
show lilly basic_displeased_cas:
    pause 0 center
    pause 0 ypos 1.17 xpos 0.55
show akira basic_boo:
    pause 0 tworight
    pause 0 ypos 1.15 xpos 0.72
show hideaki bored:
    pause 0 center
    pause 0 xpos 0.92
    easein 1.0 ypos 1.1
show shizu behind_blank_cas:
    pause 0 twoleft
    pause 0 ypos 1.11 xpos 0.27
show misha perky_smile_cas:
    pause 0 center
    pause 0 ypos 1.1 xpos 0.08
with charaenter
...
show shizu behind_blank_cas
with charachange
ssh "Would you suggest that there should there be a lineup, like in baseball? Or should it be everyone-at-once, or a tag battle style?"
show shizu basic_sparkle_cas
with charachange
...
show hideaki thinking
with charachange
hh "Family issues. Our fathers are brothers, and do not like each other."
...
scene evh shizune_hcg_tied_stare:
    pause 0 yalign 0.0 xalign 1.0 subpixel True
    easein 6.0 xalign 0.5 zoom 0.5
    pause 0 truecenter
    pause 0 zoom 1.0
    pause 0 "evh shizune_hcg_tied_stare_small"
with whiteout
...
scene evh shizune_hcg_tied_kinky2:
    pause 0 zoom 1.0 yalign 0.1 xalign 0.7
...
scene evh shizune_hcg_tied_close_small:
    pause 0 truecenter
    pause 0 subpixel True zoom 1.2
...
scene ev misha_sad:
    pause 0 truecenter
    pause 0 subpixel True zoom 1.05
    easein 10.0 zoom 1.0
with locationskip
...
label en_S26c:
"So she is treating me like I'm made of glass. For her, it's the natural way to react. I haven't forgotten how she freaked out when Emi knocked into me on my first day here. Why would it be any different for her?"
show shizu basic_normal
with charachange
"I'm sure she is remembering that, right now. I can see it on her face. She looks angry at herself."
"It would be a good opportunity to bring up that time when she saw my pills. Even though I don't want to drag that back up, it would be a good idea to. It would clear the air."
...
scene evh misha_naked:
    pause 0 xalign 1.0 ypos 0.0 subpixel True
...
scene ev misha_roof_normal:
    pause 0 yalign 1.0 xalign 0.5 subpixel True
...
scene ev shizu_flashback:
    pause 0 truecenter
    pause 0 zoom 1.15 subpixel True
