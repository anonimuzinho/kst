...
show lilly cane_satisfied:
    ease 0.5 ypos 1.3
    pause 0 "lilly basic_cheerful" with Dissolve(0.5, alpha=True)
    ease 0.5 ypos 1.0
with Pause(1.0)
hide lilly
hide hanako
...
show lilly basic_satisfied_cas_close:
    pause 0 xanchor 0.5 xpos 0.2 ypos 0.2 yanchor 0.0
    ease 1.0 xpos 0.5 xanchor 0.5 ypos 0.15
show bg city_street2:
    ease 1.0 left
with Dissolve(1.0)
...
show akira basic_smile as akira2 behind lilly:
    pause 0 tworight
    pause 0 xpos 0.78 ypos 1.13 alpha 0.0
...
"Wait a minute, if Hideaki is the son of Akira's uncle, and Shizune is his sister, then that means Lilly and Shizune's fathers are brothers. Therefore…"
...
scene ev lilly_bedroom_large:
    pause 0 xpos -130 ypos -400 subpixel True
...
scene ev lilly_bedroom_large:
    pause 0 xpos -830 ypos -200 subpixel True
...
show ev lilly_hanako_hug:
    pause 0 xalign 0.5 yalign 1.0 alpha 0.0 subpixel True
    parallel:
...
show wine:
    pause 0 yalign 0.5 xanchor 0.0 xpos 1.0 alpha 0.0
...
show akira basic_laugh
with charachange
aki "Rich words for someone practically drooling as they examine a bottle."
...
show bg school_dormlilly_ni as ovl1:
    pause 0 xalign 0.5 alpha 0.4 yalign 0.5 zoom 1.0
...
scene ev lilly_sleeping:
    pause 0 zoom 1.05 subpixel True truecenter
...
with Dissolve(0.2)
$ doublespeak(hi, li, "Woah!", "Ah!")
play sound sfx_impact2
show lilly superclose_ouch
with vpunch
show lilly basic_concerned_paj:
    pause 0 xalign 0.5 yanchor 1.0 ypos 1.2
    ease 0.4 ypos 1.4
with Dissolve(0.2)
...
show lilly basic_reminisce_paj_close
with charachange
li "Why did they leave, or why are they inviting Akira and I back?"
hi "Both, I suppose."
...
show musicbox closed behind lilly:
    pause 0 alpha 0.0 zoom 0.5 xanchor 0.0 xpos 0.5 yanchor 0.5 ypos 0.7 subpixel True
    easein 1.0 ypos 0.6 alpha 1.0
show boxstrip behind lilly:
    pause 0 alpha 0.0 zoom 0.5 xanchor 1.0 xpos 0.5 yanchor 0.5 ypos 0.7 subpixel True
    easein 1.0 ypos 0.6 alpha 1.0
with Pause (1.0)
...
show musicbox open:
    pause 0 xpos 0.5 ypos 0.6 alpha 1.0
with charachange
play music music_musicbox
...
hi "Hmm? What's wrong?"
show lilly basic_smileclosed_paj_close:
    pause 0 yalign 1.0 xpos 0.3 xanchor 0.5
    easein 1.0 xpos 0.5
with Dissolve(1.0)
...
hide lilly
with None
"And with that, she disappears behind her door and gently closes it, the muffled voices of she and Hanako audible through it much as they were yesterday night."
"…"
...
scene evbg lilly_sunsetwalk:
    pause 0 subpixel True zoom 0.9 truecenter
    acdc_warp 20.0 zoom 1.0
show evfg lilly_sunsetwalk:
    pause 0 subpixel True zoom 0.85 truecenter
    acdc_warp 20.0 zoom 1.0
with locationskip
...
show lilly cane_weaksmile_ni
with charachange
li "Not really. It was just Hanako and I having a little party during the night after school."
...
"The lettering is in pink, jarring badly with the yellow sunflower border or the card. The handwriting is neat, the characters having been written thoughtfully and with an unusual amount of care."
...
show hanako basic_distant:
    pause 0 xanchor 1.0 xpos 0.0 yalign 1.0
...
show hanako basic_normal:
    pause 0 xanchor 0.0 xpos -0.06 ypos 1.17
with charachange
...
show akira basic_boo at tworight
show hideaki bored:
    pause 0 yalign 1.0 xanchor 0.5 xpos 0.9
with charaenter
...
with charachange
li "We'd better start off then. Check-in would be ready by now."
show akira basic_lost
with charachange
stop music fadeout 2.0
