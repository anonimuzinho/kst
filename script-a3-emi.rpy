...
"I turn to head toward the girl's dormitory when I hear a shout."
emi "Hey, Hisao!"
...
show emi sad_grin_gym:
    pause 0 yalign 1.0 xanchor 0.5 xpos 0.47
    easein 0.5 center
with charaenter
...
with locationchange
"Emi seems to have snuck up on Rin and I, though Rin doesn't seem especially surprised. Which is itself unsurprising, I suppose."
...
show emi basic_grin:
    pause 0 center
    parallel:
        pause 0 "emi basic_closedgrin" with Dissolve(0.2, alpha=True)
    parallel:
...
show rin basic_deadpan behind eminude:
    pause 0 center
    pause 0 xpos 1.0 xanchor 0.0 alpha 0.0 subpixel True
...
show emi basic_closedgrin_gym:
    parallel:
        pause 0 "emi excited_proud_gym" with Dissolve(0.2, alpha=True)
    parallel:
        ease 0.2 xpos 0.6
        ease 0.2 tworight
with Pause(0.5)
...
"I have to see Emi; Misha was at least correct about that. Leaving the question of Emi and I an open issue won't work."
