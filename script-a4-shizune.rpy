...
show shizu behind_frown
with charachange
ssh "But I didn't like her because I thought she was selfish, always holding us up in order to tend to one friend of hers or another, and leaving Misha and I alone to sort out things involving the whole school by ourselves."
...
show aoi_keiko:
    pause 0 yalign 1.0 xanchor 0.5 xpos 0.0 alpha 0.0
with None
...
show bg school_council_ss:
    ...
    pause 0 center
    parallel:
        pause 0 "bg school_council_ni" with Dissolve(5.0)
    parallel:
        ease 5.0 bgleft
show shizu behind_blank_ss:
    pause 0 subpixel True
    parallel:
        pause 0 "shizu behind_blank" with Dissolve(5.0, alpha=True)
    parallel:
        ease 5.0 xpos 0.5
with None
"With that, it's just Shizune and I left alone in the student council room."
play music music_dreamy fadein 4.0
with Pause(2.0)
...
show shizu adjust_frown:
    pause 0 center
    pause 0 subpixel False ypos 1.1
with Dissolvemove(0.5)
...
scene ev shizu_badend:
    pause 0 xalign 0.0 yalign 0.5 zoom 1.1 subpixel True
