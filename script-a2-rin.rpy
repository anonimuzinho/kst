...
show emi basic_shock:
    parallel:
        ease 0.5 ypos 1.17
    parallel:
        pause 0 "emi basic_annoyed" with Dissolve(0.5, alpha=True)
    ease 0.5 ypos 1.0
with Pause(1.0)
...
show rin invis:
    pause 0 yanchor 1.0 ypos 1.2 xanchor 0.5 xpos 1.0
with None
show emi basic_grin_close:
    pause 0 xpos 0.3
...
show bg school_scienceroom:
    pause 0 subpixel True yalign 0.0
    ease 30.0 zoom 1.1
with None
...
scene ev hisao_mirror:
    pause 0 zoom 1.0 xalign 0.5 yalign 0.5 subpixel True
    ease 20.0 zoom 0.8
with locationchange
...
scene ev emitrack_running:
    pause 0 zoom 1.0 subpixel True truecenter
...
hi "So why are were here? Are you miserable then?"
...
show rin basic_lucid_close:
    ...
    pause 0 ypos 1.1
    pause 0 0.2
    pause 0 "rin basic_awayabsent_close" with Dissolve(0.3, alpha=True)
with locationchange
...
show ev rin_rain_towards:
    pause 0 xalign 0.5 yalign 0.5 zoom 1.05 subpixel True
    ease 5.0 zoom 1.0
with locationchange
...
hi "What is that you like about the sky so much?"
show rin basic_deadpannormal_close
with charachange
...
show rin negative_worried_close
with charachange
rin "The difficult part is to know where your toes are not pointing at. I mean, directions."
...
scene ev rin_kiss:
    pause 0 center
    pause 0 yalign 0.0 zoom 4.0 subpixel True
...
show ev rin_high_sleep:
    pause 0 subpixel True xalign 1.0 yalign 0.0
    ease 10.0 zoom 1.1
with None
...
$ renpy.music.set_volume(1.0, 0.5, channel="ambient")
scene ev dandelion:
    pause 0 yalign 0.5 xalign 0.5 zoom 0.8 subpixel True
    ease 20.0 zoom 0.9
with locationchange
