init -3:
    python:
        ...
        displayDict["en"].hdisabled_label = u"Desabilitar conteúdo adulto."
        ...
        displayDict["en"].s_scenes = (("Prologue", rp_actmark, rp_actmark, ("Act 1","Prologue")),
                                            ...
                                            ("The Momentary Present", "L20", "Traveling back to Yamaku, Hisao and Lilly idly talk between themselves.", ("Act 4","Lilly")),
